...
class CustomPasswordReset extends ResetPassword
{
    ...
    public function toMail($notifiable)
    {
        ...
        $email = $user->email;
        $name = $user->name;
        $url = url('/').'/#auth/password/reset?token='.$this->token.'&email='.$email;
        return (new MailMessage)
                    ->subject('Reset Password')
                    ->greeting('Hello, '.$name.'!')
                    ->line('Please click on the button below to change your password .')
                    ->action('Change Password', $url)
                    ->line('Thank you for using our service and product!');
    }
